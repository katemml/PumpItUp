#fills missing values with attribute mode
...
for col_name in attributes_using_nan:
	train_value[col_name] = train_value[col_name].fillna(train_value[col_name].mode()[0]) 
	train_value[col_name] = train_value[col_name].replace(['0'] , train_value[col_name].mode()[0])

	test_value[col_name] = test_value[col_name].fillna(test_value[col_name].mode()[0]) 
...
train_value.to_csv("cleaned_train_values.csv" , index = False)

test_value.to_csv("cleaned_test_values.csv" , index = False)
